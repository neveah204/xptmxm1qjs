...
public class SwipeSystem : MonoBehaviour
{
    ...
    void Calculate(Vector3 finalPos)                                // 계산 하는 함수
    {
        float disX = Mathf.Abs(initialPos.x - finalPos.x);          // Mathf.abs = 절댓값을 구하는 함수
        ...
        if(disX > 0 || disY > 0)
        {
            ...
            else
            {
                ...
                {
                    Character.transform.position += new Vector3(-1.0f, 0.0f, 1.0f);
                }
            }
        }
    }
